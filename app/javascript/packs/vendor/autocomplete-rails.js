...
(function(jQuery) {
  ...
  jQuery.railsAutocomplete.fn.extend = jQuery.railsAutocomplete.extend =
    jQuery.extend;
        ...
        $.extend(
          {
              ...
              jQuery.getJSON(
                ...
                function() {
                  if (arguments[0].length == 0) {
                    ...
                    if (
                      jQuery(e).attr("data-autocomplete-label") !== undefined
                    ) {
            ...
            change: function(event, ui) {
              ...
              if (jQuery(this).attr("data-update-elements")) {
                update_elements = jQuery.parseJSON(
                  jQuery(this).attr("data-update-elements")
                );
              }
              var data = ui.item
                ? jQuery(this).data(ui.item.id.toString())
                : {};
              if (
                update_elements && jQuery(update_elements["id"]).val() == ""
              ) {
                return;
              }
            ...
            select: function(event, ui) {
              ...
              if (e.delimiter != null) {
                ...
                if (jQuery(this).attr("data-update-elements")) {
                  ...
                  var update_elements = jQuery.parseJSON(
                    jQuery(this).attr("data-update-elements")
                  );
                  for (var key in update_elements) {
